...
const about = () => {
    return (<>
        <Head>
            <title>saohwan | About Page</title>
            ...
            <Layout className='pt-16'>
                ...
                <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
                    ...
                    <div className="col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light
                        ...
                        ">
                        <div className="absolute top-0 -right-3 -z-10 w-[100%] h-[102%] rounded-[2rem] bg-dark
                            dark:bg-ligh"/>
                        <Image src={profilePic} alt="Saohwan" className="w-full h-auto rounded-2xl"
