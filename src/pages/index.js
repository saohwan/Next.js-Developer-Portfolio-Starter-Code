    ...
    return (<>
            ...
            <main className="flex items-center text-dark w-full min-h-screen dark:text-light">
                    ...
                    <div className="flex items-center justify-between w-full lg:flex-col">
                        <div className="w-1/2 md:w-full">
                            <Image
                                src={profilePic}
                                alt="saohwan"
                                className="w-full h-auto lg:hidden md:inline-block md:w-full" priority sizes="(max-width: 768px) 100vw,
              ...
              50vw"
                  ...
                  "
                                    download={true} // file download Y or N
                                >Resume <LinkArrow className={"w-6 ml-1"}/>

                                </Link>
                                <Link href="mailto:saohwan@gmail.com" target={"_blank"}
